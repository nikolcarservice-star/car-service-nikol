/**
 * Vercel Serverless: мониторинг цен с KB.pl (Познань и окрестности).
 * Деплой: в корне price-monitor выполнить vercel, затем в CRM указать URL: https://ваш-проект.vercel.app/api/prices
 */
...
// Предложения из интернета для ручного ввода (нет в каталоге): название → проф. термины + ориентир цены (Познань/окрестности)
