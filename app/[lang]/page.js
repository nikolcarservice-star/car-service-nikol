...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    description:
      'Car Service Nikol – Mechanik Jastrowo, serwis samochodowy Szamotuły. Naprawa aut Jastrowo, warsztat czynny w niedzielę. Zawieszenie, hamulce, olej, diagnostyka.',
    keywords:
