...
export const DEFAULT_SERVICES = [
  { id: '1', name_pl: 'Diagnostyka komputerowa', name_ru: 'Компьютерная диагностика', laborHours: 0.7, basePrice: 100, minPrice: 80, competitorAvgPrice: 120 },
  { id: '2', name_pl: 'Kodowanie klucza', name_ru: 'Программирование ключа', laborHours: 0.8, basePrice: 250, minPrice: 200, competitorAvgPrice: 300 },
  { id: '3', name_pl: 'Wymiana klocków (oś)', name_ru: 'Замена колодок (ось)', laborHours: 0.9, basePrice: 120, minPrice: 90, competitorAvgPrice: 150 },
  { id: '4', name_pl: 'Wulkanizacja (komplet)', name_ru: 'Шиномонтаж (комплект)', laborHours: 0.8, basePrice: 120, minPrice: 90, competitorAvgPrice: 140 },
  { id: '5', name_pl: 'Serwis mobilny (dojazd)', name_ru: 'Выезд мастера', laborHours: 0.5, basePrice: 50, minPrice: 40, competitorAvgPrice: 60 },
  { id: '6', name_pl: 'Wymiana oleju i filtrów', name_ru: 'Замена масла i фильтров', laborHours: 0.8, basePrice: 80, minPrice: 60, competitorAvgPrice: 100 },
  { id: '7', name_pl: 'Wymiana tarcz i klocków (przód)', name_ru: 'Замена дисков и колодок (перед)', laborHours: 1.8, basePrice: 250, minPrice: 200, competitorAvgPrice: 280 },
  { id: '8', name_pl: 'Wymiana tarcz i klocków (tył)', name_ru: 'Замена дисков и колодок (зад)', laborHours: 1.7, basePrice: 260, minPrice: 210, competitorAvgPrice: 290 },
  { id: '9', name_pl: 'Wymiana płynu hamulcowego', name_ru: 'Замена тормозной жидкости', laborHours: 0.9, basePrice: 180, minPrice: 150, competitorAvgPrice: 210 },
  { id: '10', name_pl: 'Wymiana świec zapłonowych', name_ru: 'Замена свечей зажигания', laborHours: 0.7, basePrice: 90, minPrice: 70, competitorAvgPrice: 110 },
  { id: '11', name_pl: 'Wymiana amortyzatorów (oś)', name_ru: 'Замена амортизаторов (ось)', laborHours: 2.0, basePrice: 320, minPrice: 260, competitorAvgPrice: 360 },
  { id: '12', name_pl: 'Wymiana sprzęgła', name_ru: 'Замена сцепления', laborHours: 5.0, basePrice: 800, minPrice: 650, competitorAvgPrice: 900 },
  { id: '13', name_pl: 'Wymiana rozrządu (pasek)', name_ru: 'Замена ремня ГРМ', laborHours: 4.0, basePrice: 650, minPrice: 550, competitorAvgPrice: 750 },
  { id: '14', name_pl: 'Wymiana akumulatora', name_ru: 'Замена аккумулятора', laborHours: 0.5, basePrice: 80, minPrice: 60, competitorAvgPrice: 100 },
  { id: '15', name_pl: 'Serwis klimatyzacji', name_ru: 'Сервис кондиционера', laborHours: 1.2, basePrice: 180, minPrice: 150, competitorAvgPrice: 220 },
  { id: '16', name_pl: 'Ustawienie geometrii / zbieżność', name_ru: 'Регулировка развал-схождения', laborHours: 1.5, basePrice: 230, minPrice: 190, competitorAvgPrice: 280 },
  { id: '17', name_pl: 'Wymiana tłumika końcowego', name_ru: 'Замена заднего глушителя', laborHours: 1.1, basePrice: 190, minPrice: 150, competitorAvgPrice: 210 },
  { id: '18', name_pl: 'Wymiana łożyska koła', name_ru: 'Замена подшипника ступицы', laborHours: 1.6, basePrice: 200, minPrice: 160, competitorAvgPrice: 230 },
  { id: '19', name_pl: 'Wymiana pompy wody', name_ru: 'Замена помпы охлаждения', laborHours: 2.0, basePrice: 260, minPrice: 220, competitorAvgPrice: 310 },
